//
//  RACSignal+WBAFProgressCallbacks.m
//  WBMVVM_OCExample
//
...
#import "RACSignal+WBAFProgressCallbacks.h"
#import <objc/runtime.h>

static const char RAFNProgress_Block_Key;

@interface RACSignal (AFInternalProgressCallbacks)

@property (nonatomic, copy) void (^_progress)(float progress);

@end

@implementation RACSignal (WBAFProgressCallbacks)
